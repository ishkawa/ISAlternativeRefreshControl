...
@implementation ISGoogleRefreshControl
...
- (void)initialize
{
    ...
    self.indicatorView = [[ISGoogleIndicatorView alloc] init];
...
- (void)layoutSubviews
{
    ...
    self.indicatorView.frame = CGRectMake(self.frame.size.width/2.f-15, self.frame.size.height/2.f-15, 30, 30);
}
